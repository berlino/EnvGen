...
if __name__ == "__main__":
    ...
    argparser.add_argument("-c", "--cache", help="Where to store the cache", default=".cache/cache.json")
    argparser.add_argument("-k", "--key", help="Codex API key file", default=".cache/codex_key.txt")
